...
const OnfidoCheck = () => {
  useEffect(() => {
    Onfido.init({
      token: import.meta.env.VITE_ONFIDO_API_TOKEN, // Przekaż swój token SDK Onfido
      ...
      steps: [
        {
          ...
          options: {
            ...
            descriptions: [
              "To jest proces weryfikacji Onfido",
              "Potrzebujemy dwóch rzeczy",
              "1. Zdjęcie twojego dowodu osobistego",
              "2. Zdjęcie twojej twarzy",
            ],
            nextButton: "Rozpocznij",
          },
        },
        "document",
        "face",
      ...
      onComplete: function (data) {
        console.log("Onfido completion data:", data);
        // Tu możesz przesłać dane do swojego serwera na potrzeby dalszej weryfikacji
      },
      onError: function (error) {
        console.log("Onfido initialization error:", error);
      },
    });
  }, []);
